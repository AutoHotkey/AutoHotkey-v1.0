...
, VAR_OSTYPE, VAR_OSVERSION, VAR_ISADMIN, VAR_CURSOR, VAR_CARETX, VAR_CARETY
...
, VAR_THISMENUITEM, VAR_THISMENU, VAR_THISHOTKEY, VAR_PRIORHOTKEY, VAR_TIMESINCETHISHOTKEY, VAR_TIMESINCEPRIORHOTKEY
, VAR_ENDCHAR
